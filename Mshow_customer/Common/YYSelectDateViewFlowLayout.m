...
NSString *const YYSelectDateViewSectionBackground = @"YYSelectDateViewSectionBackground";

@implementation YYSelectDateViewFlowLayout
...
- (void)setup
{
    [self registerClass:[YYSelectDateReusableView class] forDecorationViewOfKind:YYSelectDateViewSectionBackground];
}
...
- (void)prepareLayout
{
    ...
    if (!numberOfSections || ![delegate conformsToProtocol:@protocol(YYSelectDateViewDelegateFlowLayout)]) {
        return;
    }
    ...
    for (NSInteger section = 0; section < numberOfSections; section++) {
        ...
        // 2、定义
        YYCollectionViewLayoutAttributes *attr = [YYCollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:YYSelectDateViewSectionBackground withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
...
{
    if ([elementKind isEqualToString:YYSelectDateViewSectionBackground]) {
