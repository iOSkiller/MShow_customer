...
+ (NSString *)iphoneType {
    ...
    if ([platform isEqualToString:@"iPhone10,2"]) return @"iPhone8 Plus";
...
{
    NSString *str = AppendString(@"tel:", phoneNumber);
