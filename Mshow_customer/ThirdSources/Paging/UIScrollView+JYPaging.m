...
- (void)addFirstScrollViewFooter {
    ...
    footer.stateLabel.textColor = YYDiscriptionColor;
    footer.stateLabel.font = [UIFont systemFontOfSize:RELATIVE_WIDTH(26)];
...
- (void)addSecondScrollViewHeader {
    ...
    [header setTitle:@"释放,返回商品详情" forState:MJRefreshStatePulling];
