...
- (UIView *)buidlStarViewWithImageName:(NSString *)imageName isForegroundColor:(BOOL)isForegroundColor
{
    ...
    for (int i = 0; i < self.numberOfStar; i ++)
    {
        ...
        CGFloat width = (frame.size.width - (self.numberOfStar * RELATIVE_WIDTH(24))) / self.numberOfStar;
        imageView.frame = CGRectMake(i * (width + RELATIVE_WIDTH(24)), 0, width, width);
